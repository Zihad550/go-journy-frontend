    ...
    >
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center">
          ...
          >
            <p className={subtitleStyles.base}>{HERO_MESSAGES.home.subtitle}</p>
            ...
            <div className={subtitleStyles.driverMessage}>
              <p className={subtitleStyles.driverText}>
                ...
                <span className="text-muted-foreground">
                  Flexible schedule, instant payouts, and comprehensive support.
                  Join 2,500+ successful drivers already earning with us.
                </span>
              </p>
            </div>
          </div>
