...
export function CTAButtons({ isAuthenticated = false, className = '' }: CTAButtonsProps) {
  const { ctaAnimation, primaryButtonHover, secondaryButtonHover } = useHomeAnimations();
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-2.5 sm:gap-3 md:gap-4 justify-center items-center max-w-md sm:max-w-none mx-auto">
        ...
        <Button
          ref={secondaryButtonHover as React.RefObject<HTMLButtonElement>}
          variant="outline"
          size="lg"
