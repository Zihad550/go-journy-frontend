...
const Earnings = () => {
  const {
    ...
    isLoading,
    error,
  } = useGetDriverEarningsQuery(undefined);
            ...
            {isLoading ? (
              ...
              <>
                <div className="text-2xl font-bold">
                  {formatCurrency(earnings * 0.3)}{" "}
                  {/* Placeholder - would need monthly breakdown */}
                </div>
        ...
        <Card>
          ...
          <CardContent>
            {isLoading ? (
              ...
              <>
                <div className="text-2xl font-bold">
                  {formatCurrency(earnings / 10)}{" "}
                  {/* Placeholder - would need ride count */}
                </div>
                <p className="text-xs text-muted-foreground">
        ...
        <Card>
          ...
          <CardContent>
            {isLoading ? (
              ...
              <>
                <Badge
                  variant={hasEarnings ? "default" : "secondary"}
                  className="mb-2"
                >
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="text-center p-4 border rounded-lg">
                ...
                <p className="text-sm text-muted-foreground">
                  Set your availability to online and start receiving ride
                  requests
                </p>
              </div>
              <div className="text-center p-4 border rounded-lg">
                ...
                <p className="text-sm text-muted-foreground">
                  Accept ride requests, pick up passengers, and complete
                  journeys
                </p>
              </div>
            </div>
