...
import { ACCESSIBILITY_CONFIG } from '@/components/modules/Home/constants/howItWorksSection.constants';
...
export function useTabAccessibility() {
  ...
  const createTabChangeHandler = useCallback((setActiveTab: (tab: string) => void) => {
